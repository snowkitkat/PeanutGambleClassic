namespace PeanutGambleClassic
{
    ...
    public class Config : IConfig
    {
        ...
        /// </summary>
        [Description("Allowed ItemIDs to spawn. (Ex; 48 to allow the Com45 from spawning. Valid numbers are 0-52. Do not use -1 or your console will be flooded with errors.")]
